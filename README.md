...
- [`docs/12-p1-handoff.md`](docs/12-p1-handoff.md) - kickoff brief for the P1 implementation agent (paste it, or point the agent at it). Tracks the carried-forward P0 Stop/Pause gap.
